...
contract DERIVEAESKEY {
    ...
    function deriveAESKey(bytes memory sk, bytes memory pk) public view returns (bytes32 result) {
    ...
    function testDeriveAESKey() public view {
        ...
        bytes memory sk1 = hex"7e38022030c40773cc561c1cc9c0053e48b0be2cee33c13495f096942ea176ef";
        bytes memory pk1 = hex"03f176e697b5b0c4799f1816f5fe114263d1c01a84ad296129f994278499f0842e";
        bytes memory sk2 = hex"adbed354135e517bc881d55fa60c455737d1ba98d446c0866cec3837e13d9906";
