...
use revm::{
    ...
    primitives::{address, hardfork::SpecId, keccak256, Address, Bytes, U256},
    Database,
};
    ...
    FRAME: FrameTr<FrameResult = FrameResult, FrameInit = FrameInit>,
{
    ...
    fn reimburse_caller(
        ...
        if context.chain().used_erc20_gas() {
            ...
            token_operation::<EVM::Context, ERROR>(context, TREASURY, caller, reimbursement_usdc)?;
        } else {
    ...
    fn reward_beneficiary(
        ...
        if context.chain().used_erc20_gas() {
            ...
            token_operation::<EVM::Context, ERROR>(context, TREASURY, beneficiary, reward_usdc)?;
        } else {
            // Native ETH path: standard balance_incr.
