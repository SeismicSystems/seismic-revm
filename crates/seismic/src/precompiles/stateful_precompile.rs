...
impl<CTX> StatefulPrecompiles<CTX> {
    ...
    pub fn extend<I: IntoIterator<Item = (Address, StatefulPrecompileFn<CTX>)>>(
        &mut self,
        iter: I,
    ) {
...
impl<CTX> From<(Address, StatefulPrecompileFn<CTX>)> for StatefulPrecompileWithAddress<CTX> {
...
impl<CTX> From<StatefulPrecompileWithAddress<CTX>> for (Address, StatefulPrecompileFn<CTX>) {
    // Fixed generic parameter
...
impl<CTX> StatefulPrecompileWithAddress<CTX> {
    // Fixed generic parameter
