...
use revm::{
    ...
    primitives::{
        AccountInfo, Address, Bytecode, BytecodeDecodeError, Bytes, ExecutionResult, FixedBytes,
        Output, TxKind, U256,
    },
    DatabaseCommit, Evm,
};
...
impl Cmd {
    pub fn run(&self) -> Result<(), Errors> {
        ...
        for test_file in test_files {
            ...
            let blob_hash_1 = FixedBytes::<32>::from_hex(
                "0100000000000000000000000000000000000000000000000000000000000001",
            )
            .unwrap();
            let blob_hash_2 = FixedBytes::<32>::from_hex(
            ...
            let block_prevrando = FixedBytes::<32>::from_hex(
